...
CREATE TABLE `tbl_sale` (
  `sale_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tbl_sale_device` (
  `sale_device_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `sale_id` tinyint(3) unsigned NOT NULL,
...
CREATE TABLE `tbl_user_sale_device` (
  `user_sale_device_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` tinyint(3) unsigned NOT NULL,
  `sale_device_id` tinyint(3) unsigned NOT NULL,
...
CREATE TABLE `tbl_user_uuid` (
  `user_uuid_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` tinyint(3) unsigned NOT NULL,
...
-- Dump completed on 2016-04-28  8:38:37
